...
severity: high
tags: [ccm-orchestration, native-goal-passthrough, chat-id-routing, ccm-turn-envelope, agent-control-path, worker-rooms, regression-test]
---
...
- `docs/solutions/workflow-issues/ccm-orchestration-steering-vs-execution.md` explains why hidden or manual worker operation is degraded fallback, not successful visible orchestration.
