...
6. Synthesize and challenge any internal fan-out outputs before reporting; unsupported internal findings do not count as evidence.
7. Produce a final Worker Report using `docs/orchestration/_templates/worker-report.md`, including whether internal fan-out was used, then stop.
