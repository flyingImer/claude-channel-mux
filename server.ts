...
const mcp = new Server(
  { name: 'claude-channel-mux', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      'Thread replies include prior thread messages as [Thread context] above [Current message]. Read the thread context to understand what the user is referring to before responding.',
      ...
      'If thread context was truncated or you need the full history, use fetch_thread (Slack only).',
